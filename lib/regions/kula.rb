  ...
  class Villager < BasicLoop
    STOPS = [
        ...
        BusStop.new({
                        ...
                        location: :kula_community_center
                    }),
        BusStop.new({
