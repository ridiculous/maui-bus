class Kihei < Region
  ...
  class Islander < BasicLoop
    ...
    def initialize(name='Kihei Islander Route #10')
      super(name, 120, 2) # name, time offset and # of buses
    end
  end
  ...
  class Villager < BasicRoute
    STOPS = [
        BusStop.new({
                        ...
                        times: ['', "6:05", "7:05", "8:05", "9:05", "10:05", "11:05", "12:05", "13:05", "14:05", "15:05", "16:05", "17:05", "18:05", "19:05", "20:05"],
        ...
        BusStop.new({
                        ...
                        times: ['', "6:19", "7:19", "8:19", "9:19", "10:19", "11:19", "12:19", "13:19", "14:19", "15:19", "16:19", "17:19", "18:19", "19:19", "20:19"],
                        location: :ohukai_south_kihei
                    }),
        BusStop.new({
                        name: 'Kaonoulu / S. Kihei Rd.',
        ...
        BusStop.new({
                        ...
                        times: ['', "6:22", "7:22", "8:22", "9:22", "10:22", "11:22", "12:22", "13:22", "14:22", "15:22", "16:22", "17:22", "18:22", "19:22", "20:22"],
                        location: :kulanihakoi_south_kihei
                    }),
        BusStop.new({
                        name: 'Waipuilani Rd. / S. Kihei Rd.',
        ...
        BusStop.new({
                        ...
                        times: ['', "6:26", "7:26", "8:26", "9:26", "10:26", "11:26", "12:26", "13:26", "14:26", "15:26", "16:26", "17:26", "18:26", "19:26", "20:26"],
                        location: :piikea_south_kihei_across
                    }),
        BusStop.new({
                        name: 'Piilani Shopping Center',
